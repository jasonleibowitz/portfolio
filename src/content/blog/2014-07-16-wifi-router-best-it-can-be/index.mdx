...
aliases: ['2014-07-16-wifi-router-best-it-can-be']
pubDate: 2014-07-16
description: 'How to Choose the Best Channel for Your Router'
author: 'Jason Leibowitz'
image: './cover.webp'
imageAlt: 'Model workers in blue overalls and yellow hard hats plugging an oversized Ethernet cable into a router, beside an orange road sign reading SLOW'
