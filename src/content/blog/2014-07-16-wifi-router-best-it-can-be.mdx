...
image:
  url: 'https://miro.medium.com/v2/resize:fit:2560/format:webp/1*wmqkbvet4eskWdJj7w3rGw.jpeg'
...
<CaptionedImage
  src="/blog-images/2014-07-16/wifi-networks.webp"
  alt="List of WiFi Networks on a Macintosh"
  caption="The view of the WiFi system tray button while pressing 'Alt'"
/>
...
<CaptionedImage
  src="/blog-images/2014-07-16/wifi-channel-utilities.webp"
  caption="Wireless Diagnostics’ WiFi Scan Tab showing ideal wireless channels"
/>
